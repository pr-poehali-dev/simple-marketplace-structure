          ...
          <div className="flex items-center gap-2">
            ...
            <button className="relative p-2 transition-colors"
              ...
              <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 rounded-full text-white flex items-center justify-center font-bold"
                style={{ background: '#8b0000', fontSize: '9px' }}>2</span>
            </button>
      ...
      {menuOpen && (
        <div className="md:hidden py-4 px-6 animate-fade-up"
          ...
          <input type="text" placeholder="Поиск..."
            className="mt-4 w-full px-4 py-2.5 text-sm outline-none rounded"
            style={{ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(139,0,0,0.3)', color: '#ebebeb' }} />
        </div>
      )}
    </nav>
  );
